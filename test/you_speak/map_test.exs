defmodule YouSpeak.MapTest do
  use ExUnit.Case
  doctest YouSpeak.Map

  test "keys_to_atoms with Plug.Upload returns right map" do
    upload = %Plug.Upload{}
    new_map = YouSpeak.Map.keys_to_atoms(%{"string" => upload, "map" => %{"string" => "value"}})
  ...
  test "keys_to_atoms with NaiveDateTime returns right map" do
    ...
    new_map = YouSpeak.Map.keys_to_atoms(%{"string" => datetime, "map" => %{"string" => "value"}})
  ...
  test "keys_to_atoms with Date returns right map" do
    ...
    new_map = YouSpeak.Map.keys_to_atoms(%{"string" => date, "map" => %{"string" => "value"}})
  ...
  test "keys_to_atoms with Time returns right map" do
    ...
    new_map = YouSpeak.Map.keys_to_atoms(%{"string" => time, "map" => %{"string" => "value"}})
